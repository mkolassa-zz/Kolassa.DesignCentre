<%@ Page Language="VB" AutoEventWireup="false" Inherits="RPTTest._Default" Debug="false" Codebehind="WithDLL.aspx.vb" %>
...
<cc1:clsBase runat="server" ID="rptBase" CssClass="row" />
			</div>
		</div>
