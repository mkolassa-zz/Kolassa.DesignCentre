...
Public Class ctrlImage
    ...
    Dim ctrlImg As System.Web.UI.WebControls.Image
    Dim ctrlUpload As FileUpload
    ...
    Public Overrides Sub SetFields(lsOption As String, lsValue As String)
        ...
        If SelectedItems.Count > 0 Then
            For Each lrli In SelectedItems
                ...
                ctrlImg.ImageUrl = Trim(lrli.Value)
            Next
        End If
    End Sub
    ...
    Protected Overrides Sub CreateChildControlsSub()
        ...
        '**** Image Stuff
        ctrlImg = New System.Web.UI.WebControls.Image
        ctrlImg.ID = "ctrlImageID"
        ctrlImg.ImageUrl = "https://placehold.jp/150x150.png"

        ctrlImg.Attributes.Add("height", "150px")

        uPanel1.Controls.Add(ctrlImg)
    ...
    Public Overrides Sub setValues()
        ...
        If SelectedItems.Count > 0 Then ctrlImg.ImageUrl = Trim(SelectedItems(0).ToString)
    End Sub
