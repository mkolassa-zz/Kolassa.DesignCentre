Partial Class frmQuote
    ...
    Private Sub lstClasses_AfterUpdate()
        ...
        'lstUpgradesAvail.RowSource = "SELECT tblUpgradeOptions.UnitType, tblUpgradeOptions.UpgradeCategory, " &
    ...
    Private Sub lstRooms_AfterUpdate()
        ...
        'lstClasses.RowSource = "SELECT tblUpgradeOptions.UnitType, tblUpgradeOptions.UpgradeCategory, tblUpgradeOptions.Location " &
        '"FROM tblUpgradeOptions " &
...
Err_CustomerID_DblClick:
    ...
    Private Sub sCheckPhaseComplete()
        ...
        Dim d As DropDownList = fvQuote.FindControl("cmbQuoteStatus")
...
WriteRequestStyleError:
    ...
    Protected Sub cmbPhase1Status_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        d = sender
        t = fvQuote.FindControl("txtPhase1CompleteDate")
...
ph1Status_Error:
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        cmb = Me.fvQuote.FindControl("cmbQuoteStatus")
    ...
    Public Sub PickDate()
        ...
        t = fvQuote.FindControl(pnlCalendar.ToolTip)
