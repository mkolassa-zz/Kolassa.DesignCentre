<%@ Page Language="vb" AutoEventWireup="false"  MasterPageFile="~/Site.master" Inherits="Kolassa.DesignCenter.Web.UI.frmEventLogs" Codebehind="frmEventLogs.aspx.vb" %>
...
<br />
    ...
    SelectMethod="LoadEventLogs" TypeName="clsSelectDataLoader">
        <SelectParameters>
