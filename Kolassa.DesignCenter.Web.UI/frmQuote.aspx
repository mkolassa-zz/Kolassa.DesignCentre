<%@ Page Language="vb" EnableEventValidation="false" AutoEventWireup="false" MasterPageFile="~/Site.master" codebehind="frmQuote.aspx.vb" Inherits="frmQuote"%>
...
<table class="table" id="box-table-a" border="1">
                <tr  style="vertical-align:top;" >
                    <td >
                     ...
                     <table><tr><td  style="vertical-align:top;">
                        ...
                        <asp:DetailsView  ID="dtlCusomer" runat="server" DataSourceID="odsQuotes" AutoGenerateRows="False">
                            <Fields>
                                <asp:BoundField DataField="CustomerName" ReadOnly="true" HeaderText="Customer" />
                                <asp:BoundField DataField="UnitName" ReadOnly="true" HeaderText="Unit" />
                                <asp:BoundField DataField="UnitTypeName" ReadOnly="true" HeaderText="Unit Type" />
                                <asp:BoundField DataField="UnitTypeDescription" ReadOnly="true" HeaderText="Unit Type Desc" />
                             </Fields>
                        </asp:DetailsView>
                        </td><td  style="vertical-align:top;">
                             <asp:FormView ID="fvQuote" runat="server" DataSourceID="odsQuotes">
                             <EditItemTemplate >
        ...
        <script type="text/javascript">
            $(function () {
                $('#datetimepicker1').datetimepicker();
                                              ...
                                              <asp:textbox id="txtPhase1TargetDate"    text='<%# Bind("Phase1TargetDate") %>' 
    ...
    <asp:ObjectDataSource ID="odsRooms" runat="server" SelectMethod="LoadUnitRooms" 
        ...
        <SelectParameters>
            ...
            <asp:Parameter DefaultValue="00000000-0000-0000-0000-000000000000" Name="lsID" Type="String" />
        </SelectParameters>
    </asp:ObjectDataSource>
    ...
    <asp:ObjectDataSource ID="odsQuoteStatus" runat="server" 
                SelectMethod="GetRecords" TypeName="clsLookups">
                <SelectParameters>
                    <asp:Parameter Name="LookupID" Type="String" />
                    <asp:Parameter DefaultValue="" Name="ParentID" Type="String" />
                    <asp:Parameter DefaultValue="QuoteStatus" Name="lookupType" Type="String" />
               ...
               <asp:ObjectDataSource ID="odsPhase1Status" runat="server" 
                SelectMethod="LoadLookups" TypeName="clsSelectDataLoader" OldValuesParameterFormatString="original_{0}">
                <SelectParameters>
                    <asp:SessionParameter DefaultValue="1" Name="llNodeID" SessionField="NodeID"      Type="Int64" />
