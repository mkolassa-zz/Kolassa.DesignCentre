...
Public Class clsDataLoader
    ...
    Public Function LoadReports(ByVal llCategoryID As Long) As DataSet
        ...
        If llCategoryID = 0 Then
            'MsgBox("No Category Selectedd")
            Exit Function
        End If

        lsSQL = "SELECT tblReportDescriptions.ReportID,          " & NL & _
                "       tblReportDescriptions.ReportDescription, " & NL & _
                "       tblReportDescriptions.ReportName         " & NL & _
                "FROM   tblReportCategoryMap INNER JOIN          " & NL & _
                "       tblReportDescriptions ON                 " & NL & _
                "       tblReportCategoryMap.ReportID = tblReportDescriptions.ReportID " & NL & _
                "WHERE  tblReportCategoryMap.CategoryID=" & llCategoryID & NL & _
    ...
    Public Function LoadReportControls(ByVal llReportID As Long) As DataSet
        ...
        lsSQL = "SELECT tblReportControls.*, " & _
                "       tblReportFields.* " & _
                "From   tblReportFields inner join tblReportControls on " & _
                "       tblreportfields.reportcontrol = tblreportcontrols.controlid " & _
