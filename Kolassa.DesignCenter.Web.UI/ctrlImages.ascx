<%@ Control Language="vb" AutoEventWireup="false"  CodeBehind="ctrlImages.ascx.vb" Inherits="ctrlImages" %>
<%@ Register assembly="Telerik.Web.UI" namespace="Telerik.Web.UI" tagprefix="telerik" %>

<%@ Register src="ctrlImageNew.ascx" tagname="ctrlImageNew" tagprefix="uc1" %>
...
<asp:ObjectDataSource ID="ObjectDataSource1" runat="server" SelectMethod="LoadImages" TypeName="clsSelectDataLoader" DeleteMethod="DeleteImages" InsertMethod="InsertImages" OldValuesParameterFormatString="original_{0}" UpdateMethod="Updateimages">
    <DeleteParameters>
...
<table >
    <tr><td style="width:100px;"></td><td></td></tr>
        <tr><td></td><td>
            <asp:GridView ID="GridView1" runat="server" DataSourceID="ObjectDataSource1" CssClass="table table-striped table-bordered table-hover glyphicon-hover" AutoGenerateColumns="False">
                <Columns>
