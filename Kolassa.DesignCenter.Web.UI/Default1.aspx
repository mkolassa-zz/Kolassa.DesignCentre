<%@ Page Title="Home Page" Language="VB" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Default1.aspx.vb" Inherits="Default1" %>

<%@ Register Assembly="Telerik.Web.UI" Namespace="Telerik.Web.UI" TagPrefix="telerik" %>
<%@ Register Src="~/ctrlSubObjects.ascx" TagPrefix="uc1" TagName="ctrlSubObjects" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <telerik:radajaxloadingpanel ID="RadAjaxLoadingPanel1" runat="server">
     ...
     <div class="demo-container no-bg">
        <h3>Customers:</h3>
        <telerik:radgrid RenderMode="Lightweight" ID="rgMaster" runat="server" AllowPaging="True" PageSize="10" 
            DataSourceID="odsCustomer"   OnItemCommand="rgMaster_ItemCommand">
        ...
        <telerik:radgrid RenderMode="Lightweight" ID="RadGrid2" ShowStatusBar="True" runat="server" AllowPaging="True"
            PageSize="5" DataSourceID="odsContact">
...
<asp:ObjectDataSource ID="odsContact" runat="server" SelectMethod="GetContacts" TypeName="Contacts" OldValuesParameterFormatString="original_{0}">
    <SelectParameters>
