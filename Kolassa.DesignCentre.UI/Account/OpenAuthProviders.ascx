<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="OpenAuthProviders.ascx.vb" Inherits="Kolassa.DesignCentre.UI.OpenAuthProviders" %>

<div id="socialLoginList" hidden="hidden">
