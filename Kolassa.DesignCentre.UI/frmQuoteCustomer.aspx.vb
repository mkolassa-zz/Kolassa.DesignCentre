...
ph1Status_Error:
    ...
    Protected Sub odsRequestedUpgrades_Inserting(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.ObjectDataSourceMethodEventArgs) 'Handles odsRequestedUpgrades.Inserting
        ...
        For Each dr In ds.Tables(0).Rows
            ...
            Dim lsroomdesc As String = IIf(lvRoomHorizontal.SelectedValue = "", "", lvRoomHorizontal.SelectedValue) ' IIf(lvRoomHorizontal.SelectedValue="" lstRooms.SelectedValue = "", "", lvRoomHorizontal.SelectedValue) ' lstRooms.SelectedValue)
...
Err_cmdAutoPick_Click:
    ...
    Protected Sub cmdSelectedItemSave_Click(sender As Object, e As EventArgs) Handles cmdSelectedItemSave.Click
        ...
        p.RoomDescription = lvRoomHorizontal.SelectedValue ' lstRooms.SelectedValue
        p.Standard = 1
    ...
    Protected Sub lstRooms_SelectedIndexChanged(sender As Object, e As EventArgs) Handles lvRoomHorizontal.SelectedIndexChanged ' lstRooms.SelectedIndexChanged
    ...
    Protected Sub lstitems_DataBinding(sender As Object, e As EventArgs) Handles lstitems.DataBinding
        ' Stop
    End Sub

    Private Sub lstitems_DataBound(sender As Object, e As EventArgs) Handles lstitems.DataBound
        'Stop
        Dim lsbox As ListBox = sender
        Dim i As Integer
        For Each l As ListItem In lsbox.Items
            i = i + 10
            l.Attributes.Add("data-img-label", l.Text)
            l.Attributes.Add("data-img-src", "http://placekitten.com/" & 130 + i & "/200")
        Next
    End Sub
End Class