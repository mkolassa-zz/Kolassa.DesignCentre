...
Namespace Migrations
    ...
    Public NotInheritable Partial Class UserFriendlyName
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(UserFriendlyName))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "201806022156160_UserFriendlyName"
            End Get
        End Property
