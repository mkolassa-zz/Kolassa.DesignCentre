<%@ Control Language="vb" AutoEventWireup="false"  codebehind="ctrlContacts.ascx.vb" Inherits="Kolassa.DesignCentre.UI.ctrlContacts" %>
...
<asp:ObjectDataSource ID="odsContact" runat="server" 
    ...
    <asp:Parameter Name="lsObjectID" Type="String" />
        <asp:SessionParameter DefaultValue="" Name="NodeID" SessionField="NodeID" Type="Int32" />
        <asp:Parameter Name="Active" Type="Boolean" DefaultValue="true" />
           ...
           <h2> <asp:Label ID="lblContacts" runat="server" Text="Contacts" ></asp:Label></h2>
