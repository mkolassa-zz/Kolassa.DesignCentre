<%@ Control Language="vb" AutoEventWireup="false"  CodeBehind="ctrlSubObjects.ascx.vb" Inherits="Kolassa.DesignCentre.UI.ctrlSubObjects" %>
<%@ Register assembly="Telerik.Web.UI" namespace="Telerik.Web.UI" tagprefix="telerik" %>
<%@ Register Src="~/Controls/ctrlContacts.ascx" TagPrefix="uc1" TagName="ctrlContacts" %>
