...
Partial Public Class ctrlSubObjects
    ...
    '''To modify move field declaration from designer file to code-behind file.
    '''</remarks>
    Protected WithEvents ctrlCustomers As Global.Kolassa.DesignCentre.UI.ctrlCustomers
    ...
    '''To modify move field declaration from designer file to code-behind file.
    '''</remarks>
    Protected WithEvents ctrlContacts As Global.Kolassa.DesignCentre.UI.ctrlContacts
