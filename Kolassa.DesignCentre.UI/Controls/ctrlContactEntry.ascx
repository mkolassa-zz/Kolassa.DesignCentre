<%@ Control Language="vb" AutoEventWireup="false"  CodeBehind="ctrlContactEntry.ascx"  Inherits="Kolassa.DesignCentre.UI.ctrlContactEntry" %>
<asp:ObjectDataSource ID="odsContact" runat="server" 
        SelectMethod="GetContacts" 
        UpdateMethod="UpdateContacts" 
        TypeName="Kolassa.DesignCentre.UI.clsContacts" 
        OldValuesParameterFormatString="original_{0}" 
        DataObjectTypeName="Kolassa.DesignCentre.UI.clsContact" 
