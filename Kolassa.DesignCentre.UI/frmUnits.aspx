<%@ Page Language="vb" EnableEventValidation=false AutoEventWireup="false" MasterPageFile="~/Site.Master" Inherits="Kolassa.DesignCentre.UI.frmUnits" Codebehind="frmUnits.aspx.vb" %>
...
<link href="~/Content/bootstrap-datetimepicker.min.css" rel="stylesheet" />
    ...
    <asp:Panel ID="Panel1" runat="server" >
		<cc2:ReportContainer  ID="
			
			" runat="server"  ReportCategoryType="frmVendors"  />
...
<table style="width: 100%;"><tr><td>
               ...
               <asp:CommandField
                   ...
                   <asp:Templatefield HeaderText="ID" SortExpression="ID" Visible="false">          
                      ...
                      <asp:Templatefield HeaderText="Unit Code" SortExpression="UnitCode"> 
                        ...
                        <itemTemplate>            
                            <asp:Literal id="UnitID" runat="server"  Text='<%# Bind("UnitCode") %>'  />
                        </ItemTemplate> 
                        <EdititemTemplate>
                             <asp:TextBox Width=100px id="UnitID" MaxLength=10 runat="server" Text='<%# Container.DataItem("UnitCode") %>'/>
                        </EditItemTemplate>                  
                    </asp:TemplateField>
                 ...
                 <asp:TemplateField HeaderText="Name" SortExpression="UnitName">
                    ...
                    <asp:TemplateField HeaderText="Unit Type" SortExpression="ID">
                        <FooterTemplate>
                            <asp:DropDownList ID="cboUnitTypeID" runat="server" DataTextField="UnitTypeName" DataValueField="ID"  DataSourceid="odsUnitTypes" > </asp:DropDownList>
                        </FooterTemplate>
                        <EditItemTemplate>
                            <asp:TextBox id="txtUnitTypeID" MaxLength=50 runat="server" Text='<%# Container.DataItem("UnitTypeName") %>' Visible=false  />
                            <asp:DropDownList ID="cboUnitTypeID" runat="server" DataTextField="UnitTypeName" DataValueField="ID"  DataSourceid="odsUnitTypes" SelectedValue='<%# Container.DataItem("ID") %>'/> 
                        </EditItemTemplate>
                         <itemTemplate>
                               <asp:Literal id="UnitTypeID" runat="server" Visible=false  Text='<%# Container.DataItem("UnitTypeName") %>'  />
                            <asp:Literal id="litUnitTypeName" runat="server"  Text='<%# Container.DataItem("UnitTypeName") %>'  />
                        </ItemTemplate>
                    </asp:TemplateField>
    ...
    <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" 
      SelectMethod="LoadUnits" TypeName="Kolassa.DesignCentre.Data.clsSelectDataLoader" InsertMethod="InsertUnits" UpdateMethod="UpdateUnits"
       DeleteMethod="DeleteUnits"   >
        ...
        <SelectParameters>
            ...
            <asp:SessionParameter SessionField="Project" Name="lsObjectID" Type="String" />
    ...
    <asp:ObjectDataSource ID="odsUnitTypes" runat="server" 
        SelectMethod="LoadUnitTypes" TypeName="Kolassa.DesignCentre.Data.clsSelectDataLoader">
        <SelectParameters>
            <asp:SessionParameter DefaultValue="1" Name="llNodeID" SessionField="NodeID"                 Type="Int64" />
    ...
    <asp:ObjectDataSource ID="odsTiers" runat="server" 
        SelectMethod="LoadTiers" TypeName="Kolassa.DesignCentre.Data.clsSelectDataLoader">
        <SelectParameters>
            <asp:SessionParameter DefaultValue="1" Name="llNodeID" SessionField="NodeID"                 Type="Int64" />
            <asp:Parameter DefaultValue="" Name="lsWhere" Type="String" />
        ...
        SelectMethod="LoadFloors" TypeName="Kolassa.DesignCentre.Data.clsSelectDataLoader">
        <SelectParameters>
            <asp:SessionParameter DefaultValue="1" Name="llNodeID" SessionField="NodeID"                 Type="Int64" />
            <asp:Parameter DefaultValue="" Name="lsWhere" Type="String" />
            <asp:Parameter Name="lbActive" Type="Boolean" />
    ...
    <asp:ObjectDataSource ID="odsDepositConditions" runat="server" 
        SelectMethod="LoadDepositConditions" TypeName="Kolassa.DesignCentre.Data.clsSelectDataLoader">
        <SelectParameters>
            <asp:SessionParameter DefaultValue="1" Name="llNodeID" SessionField="NodeID"                 Type="Int64" />
            <asp:Parameter DefaultValue="" Name="lsWhere" Type="String" />
            <asp:Parameter Name="lbActive" Type="Boolean" />
